...
class Restaurant extends ChangeNotifier {
  final List<Food> menu = [
    ...
    Food(
        ...
        imagePath: "assets/images/burgers/bbq_bacon.png",
        price: 7.99,
    ...
    Food(
        ...
        imagePath: "assets/images/burgers/big_onion.png",
        price: 8.50,
        category: FoodCategory.burgers,
        addons: [
    ...
    Food(
        ...
        imagePath: "assets/images/burgers/classic_cheesburger.png",
        price: 7.00,
        category: FoodCategory.burgers,
        addons: [
    ...
    Food(
        ...
        imagePath: "assets/images/burgers/spicy_jalapeno.png",
        price: 8.99,
        category: FoodCategory.burgers,
        addons: [
    ...
    Food(
        ...
        imagePath: "assets/images/burgers/truffle_mushroom.png",
        price: 9.00,
        category: FoodCategory.burgers,
        addons: [
    ...
    Food(
        ...
        imagePath: "assets/images/desserts/chocolade_lava.png",
        price: 8.50,
    ...
    Food(
        ...
        imagePath: "assets/images/desserts/strawberry_cake.png",
        price: 9.20,
        category: FoodCategory.desserts,
        addons: [
    ...
    Food(
        ...
        imagePath: "assets/images/drinks/chocolade.png",
        price: 3.20,
    ...
    Food(
        ...
        imagePath: "assets/images/drinks/matcha.png",
        price: 3.50,
        category: FoodCategory.drinks,
        addons: [
    ...
    Food(
        ...
        imagePath: "assets/images/salads/avocado.png",
        price: 6.50,
    ...
    Food(
        ...
        imagePath: "assets/images/salads/cesar.png",
        price: 7.20,
        category: FoodCategory.salads,
        addons: [
    ...
    Food(
        ...
        imagePath: "assets/images/sides/fries.png",
        price: 1.70,
    ...
    Food(
        ...
        imagePath: "assets/images/sides/mozarella_sticks.png",
        price: 2.00,
        category: FoodCategory.sides,
        addons: [
          Addon(name: "Ketchup", price: 0.15),
    ...
    Food(
        ...
        imagePath: "assets/images/sides/potato_wedges.png",
        price: 2.20,
        category: FoodCategory.sides,
        addons: [
